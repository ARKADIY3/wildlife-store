...
<h1>Добро пожаловать в Wildlife!</h1>

<h2>Популярные товары</h2>
<div class="products-grid">
<?php while ($product = $result->fetch_assoc()): ?>
    <div class="product-card">
        <img src="/wildlife/uploads/products/<?php echo htmlspecialchars($product['image']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>" width="200">
